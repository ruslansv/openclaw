...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie wyczyszczono żadnej zapisanej sesji WhatsApp. Może już nie istnieć lub jej katalog uwierzytelniania może wymagać ręcznego wyczyszczenia.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG lub WebP. Obrazy są przycinane od środka i skalowane do 512px.",
      profileLoadFailed: "Nie udało się załadować Twojego profilu.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Powiadomienia dla OpenClaw są wyłączone w macOS. Zezwól na nie w Ustawienia systemowe > Powiadomienia.",
    },
    appearance: {
      theme: "Motyw",
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co ma się pojawiać podczas trwających sesji.",
      liveActivity: "Pokaż aktywność agenta na żywo na pasku bocznym",
      liveActivityHint: "Pokaż najnowszą aktywność asystenta lub narzędzia pod trwającymi sesjami.",
    },
    connection: {
      title: "Połączenie",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    connectionChanged: "Połączenie z Gateway uległo zmianie. Ponów, aby kontynuować konfigurację.",
    sessionRestarted:
    ...
    nudge: {
      configReload: "Ponowne ładowanie konfiguracji zatrzymane — zapytaj mnie, co się stało",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Pozwól Code Mode koordynować grupy podagentów równolegle.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Towarzysz w pasku menu dla Twojego Gateway — powiadomienia, zatwierdzenia, szybki czat.",
      },
      windows: {
        title: "Windows",
      ...
      plugins: {
        ...
        desc: "Rozszerzaj OpenClaw o kanały, narzędzia i umiejętności ze społeczności.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmailsDescription: "Adresy e-mail powiązane z tym profilem.",
  ...
  board: {
    ...
    emptyHint: "Twój agent może tutaj przypiąć widżety — spróbuj poprosić o kartę statusu.",
    actionFailed: "Nie można zapisać zmiany w panelu.",
    actionInProgress: "Inna zmiana w panelu jest wciąż zapisywana.",
    announcement: {
      moved: "Przeniesiono {title}.",
      resized: "Zmieniono rozmiar {title}.",
      removed: "Usunięto {title}.",
      granted: "Zezwolono na dostęp do widżetu.",
      rejected: "Odrzucono dostęp do widżetu.",
    },
    widget: {
      cellLabel:
        "Widżet panelu: {title}. Użyj strzałek do nawigacji. Przytrzymaj Alt i naciśnij strzałkę, aby go przenieść.",
      ...
      appStaleDetail: "Jej serwer, zasób lub pierwotny transkrypt nie jest już dostępny.",
      retry: "Ponów",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Zmiana gałęzi jest niedostępna, gdy agent pracuje.",
    ...
    modelControls: {
      ...
      usingDefault: "Używa wartości domyślnej z Ustawień",
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Dyktowanie zatrzymano przed sfinalizowaniem ostatniego częściowego transkryptu.",
