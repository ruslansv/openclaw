...
export const pt_BR: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "As notificações estão desativadas para o OpenClaw no macOS. Permita-as em Configurações do Sistema > Notificações.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Mostrar atividade ao vivo do agente na barra lateral",
      liveActivityHint:
  ...
  custodian: {
    ...
    placeholder: "Enviar mensagem para o OpenClaw…",
    ...
    nudge: {
      ...
      channelDegraded: "{channel} está degradado — pergunte-me o que aconteceu",
  ...
  mcpServers: {
    ...
    nameInvalid: "Os nomes de servidor usam letras, números, pontos, traços ou sublinhados.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "As alterações são salvas imediatamente e se aplicam a futuras execuções do agente.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "O companion para Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Companheiro na barra de menus para o seu Gateway — notificações, aprovações, conversa rápida.",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmailsDescription: "Endereços de email conectados a este perfil.",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Ancorar chat à esquerda",
      dockRight: "Ancorar chat à direita",
      dockBottom: "Ancorar chat embaixo",
      dockHidden: "Ocultar chat",
      resizeDock: "Redimensionar dock do chat",
      reopenChat: "Mostrar chat",
      defaultTab: "Principal",
      mockPlaceholder: "Junção da visão de quadro · {tabs} abas · {widgets} widgets",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "As alterações são aplicadas quando você iniciar a próxima sessão do Talk.",
      ...
      holdToRecordSettingDescription:
        "Segure o botão de microfone do compositor, fale e solte para inserir o texto sem enviar.",
    ...
    toolCards: {
      ...
      pinToDashboard: "Fixar no dashboard",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "É necessário acesso de escrita do operador para abrir esta discussão.",
