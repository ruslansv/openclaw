...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    labs: "Capacités expérimentales d'agents et d'outils.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Ce qui a changé sur ce système, les plus récentes en premier.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Permettez aux agents de combiner des outils dans des workflows JavaScript compacts et cloisonnés.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats en un coup d'œil et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    widget: {
      ...
      errorTitle: "Ce widget n'a pas pu être chargé",
      errorDetail: "Le problème est limité à cette carte.",
      actionErrorTitle: "La modification du widget a échoué",
  ...
  chat: {
    ...
    modelControls: {
      ...
      resetToDefault: "Réinitialiser la valeur par défaut ({model})",
    },
    sideChat: {
    ...
    toolCards: {
      ...
      widgetExportRerender: "Ce widget doit être réaffiché pour être exporté en tant qu'image.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess:
        "L'accès en écriture de l'opérateur est requis pour ouvrir cette discussion.",
