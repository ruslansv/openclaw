...
export const fa: TranslationMap = {
  ...
  sessionsView: {
    ...
    attentionRequired: "این جلسه به توجه نیاز دارد",
    model: "مدل",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG، PNG یا WebP. تصاویر از مرکز برش داده و به اندازه ۵۱۲ پیکسل تغییر اندازه می‌یابند.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "آخرین فعالیت دستیار یا ابزار را در زیر نشست‌های در حال اجرا نشان بده.",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    custodian: "راه‌اندازی و مراقبت از سیستم.",
    ...
    security: "احراز هویت Gateway، خط‌مشی exec، نمایه ابزار و تأییدها.",
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "این ویرایش دستی اعتبارسنجی پیکربندی را با موفقیت نگذراند.",
  ...
  mcpServers: {
    ...
    nameTaken: "سروری از نوع MCP با نام «{name}» از قبل وجود دارد.",
  ...
  labsPage: {
    intro:
      "Labs شامل قابلیت‌های آزمایشی است که ممکن است بین نسخه‌ها تغییر کند، از کار بیفتد یا ناپدید شود.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "به عامل‌ها اجازه دهید ابزارها را در گردش‌کارهای جاوااسکریپت فشرده و ایزوله ترکیب کنند.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "چت‌های قابل مشاهده در یک نگاه و پاسخ‌های سریع از روی مچ شما.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      chrome: {
        title: "افزونه Chrome",
        desc: "به OpenClaw اجازه دهید Chrome موجود شما را هدایت کند — زبانه‌ها، صفحات و فرم‌ها.",
      },
      plugins: {
  ...
  board: {
    ...
    emptyTitle: "یک برد خالی، آماده برای کار",
    ...
    widget: {
      cellLabel:
        "ابزارک داشبورد: {title}. برای پیمایش از کلیدهای جهت‌دار استفاده کنید. برای جابه‌جایی، Alt را نگه دارید و یک کلید جهت‌دار را فشار دهید.",
      ...
      rejectedDetail: "این ابزارک تا زمانی که حذف یا جایگزین نشود غیرفعال می‌ماند.",
      ...
      frameAuthorizationFailed: "احراز هویت ابزارک پس از تلاش‌های مکرر برای تازه‌سازی ناموفق بود.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "هنگام کار کردن عامل، تعویض شاخه در دسترس نیست.",
    ...
    board: {
      ...
      dockMenu: "پنل گفت‌وگو: {dock}",
      dockLeft: "پنل گفت‌وگو به چپ",
      dockRight: "پنل گفت‌وگو به راست",
      dockBottom: "پنل گفت‌وگو به پایین",
      dockHidden: "پنهان کردن گفت‌وگو",
      resizeDock: "تغییر اندازه پنل گفت‌وگو",
      reopenChat: "نمایش گفت‌وگو",
      defaultTab: "اصلی",
      mockPlaceholder: "درز نمای تخته · {tabs} برگه · {widgets} ابزارک",
    ...
    questions: {
      ...
      answeredElsewhere: "پاسخ‌داده‌شده در جای دیگر",
      unavailable: "در دسترس نیست",
      expired: "منقضی‌شده",
      cancelled: "لغوشده",
    },
    messages: {
      ...
      rewindUnavailable: "بازگردانی هنگام کار عامل در دسترس نیست",
    ...
    composer: {
      ...
      noCameras: "دوربین دیگری پیدا نشد",
      ...
      dictationBrowserAudioUnsupported: "این مرورگر نمی‌تواند صدای دیکته را در ۸ کیلوهرتز ضبط کند.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "برای برون‌سپاری به‌صورت تصویر، این ویجت باید دوباره رندر شود.",
      widgetExportFailed: "برون‌سپاری ویجت ناموفق بود. دوباره تلاش کنید.",
    ...
    sessionDiscussion: {
      ...
      opened: "گفتگوی نشست",
      openExternal: "باز کردن گفتگو در تب جدید",
