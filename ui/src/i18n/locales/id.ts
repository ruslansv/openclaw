...
export const id: TranslationMap = {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} menurun — tanyakan pada saya apa yang terjadi",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Perubahan langsung tersimpan dan berlaku untuk proses agen di masa mendatang.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Aplikasi pendamping menu bar untuk Gateway Anda — notifikasi, persetujuan, obrolan cepat.",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Nama tampilan",
      displayNameDescription: "Ditampilkan ke orang lain yang menggunakan gateway ini.",
  ...
  board: {
    ...
    widget: {
      ...
      rejectedDetail: "Widget ini tetap nonaktif hingga dihapus atau diganti.",
      appLoading: "Memulihkan aplikasi…",
      appStaleTitle: "Aplikasi yang disematkan ini usang",
      ...
      actionErrorDetail: "Dashboard mempertahankan status widget sebelumnya.",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Dokkan chat ke kiri",
      dockRight: "Dokkan chat ke kanan",
      dockBottom: "Dokkan chat ke bawah",
    ...
    modelControls: {
      ...
      reasoning: "Penalaran",
      speed: "Kecepatan",
      sessionOverride: "Penggantian utas",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Widget ini perlu di-render ulang untuk diekspor sebagai gambar.",
