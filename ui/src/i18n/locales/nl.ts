...
export const nl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Uitgelogd.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Deze is mogelijk al afwezig, of de auth-map moet mogelijk handmatig worden opgeschoond.",
    },
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Meldingen worden systeemeigen weergegeven door de OpenClaw-app op deze Mac.",
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "Toon de nieuwste assistent- of tool-activiteit onder actieve sessies.",
    },
    connection: {
      title: "Verbinding",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Deze handmatige wijziging is niet door de configuratievalidatie gekomen.",
      opaqueChange:
        "Opmaak of opmerkingen gewijzigd zonder zichtbare wijzigingen in configuratiepaden.",
      sources: {
  ...
  labsPage: {
    ...
    sectionDescription:
      "Wijzigingen worden direct opgeslagen en toegepast op toekomstige agent-runs.",
    documentation: "Documentatie",
    restartRequired: "Herstart van de Gateway vereist.",
    saveErrorTitle: "Functie kon niet worden bijgewerkt",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Snelle blikken op chats en snelle antwoorden vanaf je pols.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  presence: {
    rosterLabel: "Toon wie er online is",
    rosterTitle: "Online",
    you: "jij",
  },
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Weergavenaam",
      displayNameDescription: "Zichtbaar voor anderen die deze gateway gebruiken.",
  ...
  board: {
    ...
    emptyTitle: "Een leeg board, klaar voor gebruik",
    ...
    widget: {
      ...
      appStaleDetail: "De server, resource of bijbehorend transcript is niet langer beschikbaar.",
      retry: "Opnieuw proberen",
      frameResolverMissing: "Widgetinhoud is niet beschikbaar.",
      frameAuthorizationFailed: "Widgetautorisatie mislukt na herhaalde vernieuwingspogingen.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Vertakking wisselen vereist operator-adminrechten.",
    ...
    board: {
      ...
      dockLeft: "Chat links docken",
      dockRight: "Chat rechts docken",
      dockBottom: "Chat onderaan docken",
      dockHidden: "Chat verbergen",
      resizeDock: "Chatdock vergroten/verkleinen",
      reopenChat: "Chat tonen",
      defaultTab: "Hoofd",
      mockPlaceholder: "Board view seam · {tabs} tabbladen · {widgets} widgets",
    ...
    messages: {
      ...
      forkUnavailable: "Fork is niet beschikbaar terwijl de agent werkt",
    ...
    composer: {
      ...
      dictationDisconnected: "Dictaat is gestopt omdat de Gateway de verbinding heeft verbroken.",
      dictationFailed: "Dictaat is mislukt.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Schrijftoegang voor operator is vereist om deze discussie te openen.",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Draait elke seconde",
      ...
      summaryEverySeconds: "Draait elke {amount} seconden",
