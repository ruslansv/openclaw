...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı bir WhatsApp oturumu temizlenmedi. Zaten yok olabilir veya kimlik doğrulama dizini elle temizlenmeyi gerektirebilir.",
    },
  ...
  sessionsView: {
    ...
    attentionRequired: "Oturum ilgilenmenizi gerektiriyor",
    model: "Model",
    provider: "Sağlayıcı",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görüntüler ortadan kırpılır ve 512px olarak yeniden boyutlandırılır.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için bildirimler macOS'te devre dışı. Bunlara Sistem Ayarları > Bildirimler bölümünden izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  subtitles: {
    ...
    notifications: "Gateway'inizden tarayıcı anlık bildirimleri.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Yapılandırma yeniden yükleme durduruldu — ne olduğunu bana sorun",
  ...
  mcpPage: {
    connectorsLink: "Eklentiler sayfasında tek tıklamayla kullanılan bağlayıcıları keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Code Mode'un alt aracı gruplarını paralel olarak düzenlemesine izin verin.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Gateway'iniz için menü çubuğu yardımcı uygulaması — bildirimler, onaylar, hızlı sohbet.",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        ...
        desc: "OpenClaw'ın mevcut Chrome'unuzu yönetmesine izin verin — sekmeler, sayfalar ve formlar.",
      },
      plugins: {
  ...
  board: {
    ...
    emptyHint: "Aracınız buraya widget'lar sabitleyebilir — bir durum kartı isteyin.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Aracı çalışırken dal değişimi kullanılamaz.",
    ...
    board: {
      ...
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü birleşimi · {tabs} sekme · {widgets} widget",
    ...
    messages: {
      ...
      hide: "Gizle",
      hideConfirm: "Bu mesaj bu tarayıcıda gizlensin mi? Aracı hâlâ görebilir.",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Composer mikrofon düğmesini basılı tutun, konuşun, ardından göndermeden metin eklemek için bırakın.",
      ...
      dictationFinalizationTimedOut: "Son kısmi transkript sonuçlandırılmadan dikte durduruldu.",
