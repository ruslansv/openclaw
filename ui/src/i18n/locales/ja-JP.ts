...
export const ja_JP: TranslationMap = {
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange: "表示可能な構成パスの変更を伴わずに、書式またはコメントが変更されました。",
      sources: {
    ...
    nudge: {
      ...
      channelAuth: "{channel} の認証が劣化しました — 何が起きたか尋ねてください",
      channelDisconnected: "{channel} の接続が切断されました — 何が起きたか尋ねてください",
      channelDegraded: "{channel} が劣化しています — 何が起きたか尋ねてください",
      channelFallback: "チャンネル",
      dismiss: "このアップデートを閉じる",
    },
  },
  mcpServers: {
    add: "サーバーを追加",
    ...
    missing: "MCP サーバー「{name}」は設定内に見つかりませんでした。",
  ...
  labsPage: {
    intro:
      "Labs にはリリース間で変更、破損、または消失する可能性がある実験的機能が含まれています。",
    sectionTitle: "実験的機能",
  ...
  appsPage: {
    ...
    heroTagline:
      "スマートフォン、時計、デスクトップ、ブラウザ向けのコンパニオンアプリ、さらにエージェントの機能を拡張するプラグイン。",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Androidスマートフォンを完全なOpenClawノードとして使用 — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "手首でひと目で分かるチャットとクイック返信。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "AndroidコンパニオンがOpenClawを腕時計まで拡張します。",
      },
      macos: {
        title: "macOS",
  ...
  profilePage: {
    ...
    identity: {
      title: "アイデンティティ",
      description: "この Gateway でのプロフィール。",
  ...
  board: {
    ...
    emptyTitle: "作業を始められるクリーンなボード",
    emptyHint:
      "エージェントはここにウィジェットをピン留めできます — ステータスカードをリクエストしてみましょう。",
    ...
    widget: {
      ...
      appStaleDetail: "そのサーバー、リソース、または元のトランスクリプトはもう利用できません。",
      retry: "再試行",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "ブランチの切り替えにはオペレーター管理者権限が必要です。",
    ...
    messages: {
      ...
      rewindUnavailable: "エージェントの処理中は巻き戻しできません",
      forkUnavailable: "エージェントの処理中はフォークできません",
      unknownDate: "不明な日付",
      voiceNote: "ボイスメモ",
    },
    modelControls: {
    ...
    composer: {
      ...
      dictationAudioUnsupported:
        "Gateway がサポートされていない音声入力の音声フォーマットを返しました。",
      dictationBrowserAudioUnsupported: "このブラウザは 8 kHz での音声入力をキャプチャできません。",
      dictationConnecting: "音声入力を開始しています…",
      dictationDisconnected: "Gateway が切断されたため音声入力を停止しました。",
      dictationFailed: "音声入力に失敗しました。",
      dictationFinalizing: "音声入力を終了しています…",
      dictationFinalizationTimedOut:
        "最後の部分的な文字起こしが確定される前に音声入力が停止しました。",
      dictationProviderUnavailable: "音声入力用の文字起こしプロバイダが設定されていません。",
