...
export const de: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Es wurde keine gespeicherte WhatsApp-Sitzung gelöscht. Sie ist möglicherweise bereits nicht vorhanden, oder ihr Auth-Verzeichnis erfordert eine manuelle Bereinigung.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Hast du die App noch nicht?",
  ...
  subtitles: {
    ...
    apps: "Companion-Apps für Smartphone, Uhr, Desktop und Browser.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Neuladen der Konfiguration gestoppt — fragen Sie mich, was passiert ist",
      channelAuth:
        "Authentifizierung von {channel} beeinträchtigt — fragen Sie mich, was passiert ist",
      channelDisconnected: "{channel} wurde gerade getrennt — fragen Sie mich, was passiert ist",
      channelDegraded: "{channel} ist eingeschränkt – frag mich, was passiert ist",
  ...
  mcpServers: {
    ...
    configUnavailable: "Konfiguration ist nicht verfügbar; aktualisiere und versuche es erneut.",
    connectRequired: "Verbinde dich mit dem Gateway, um MCP-Server zu ändern.",
  ...
  mcpPage: {
    connectorsLink: "Entdecke Ein-Klick-Connectors auf der Plugins-Seite.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Lassen Sie Agents Tools in kompakten, isolierten JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
      description: "Lassen Sie Code Mode Gruppen von Subagents parallel orchestrieren.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für Ihr Telefon, Ihre Uhr, Ihren Desktop und Ihren Browser – plus Plugins, um die Fähigkeiten Ihres Agents zu erweitern.",
    sectionMobile: "Auf Ihrem Telefon",
    havePhone: "Sie haben die App bereits?",
    pairDevice: "Koppeln Sie Ihr Gerät",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatte, sprich, bestätige Aktionen und teile Inhalte von iOS aus in OpenClaw.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats auf einen Blick und Schnellantworten von deinem Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Die Android-Begleit-App erweitert OpenClaw auf Ihre Uhr.",
      },
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleit-App für Ihr Gateway – Benachrichtigungen, Freigaben, schneller Chat.",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Wähle ein Bild, das höchstens 10 MB groß ist.",
  ...
  board: {
    ...
    widget: {
      ...
      resizeHandle: "{title} in der Größe ändern",
      ...
      appStaleDetail:
        "Ihr Server, ihre Ressource oder ihr ursprüngliches Transkript ist nicht mehr verfügbar.",
      retry: "Erneut versuchen",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSetting: "Mikrofonschaltfläche zum Diktieren gedrückt halten",
      holdToRecordSettingDescription:
        "Halten Sie die Mikrofonschaltfläche im Editor gedrückt, sprechen Sie und lassen Sie los, um Text einzufügen, ohne ihn zu senden.",
      dictationAudioUnsupported:
        "Das Gateway hat ein nicht unterstütztes Audioformat für das Diktieren zurückgegeben.",
      dictationBrowserAudioUnsupported:
        "Dieser Browser kann kein Diktier-Audio mit 8 kHz aufnehmen.",
      dictationConnecting: "Diktieren wird gestartet…",
      dictationDisconnected:
        "Das Diktieren wurde beendet, da die Verbindung zum Gateway getrennt wurde.",
      dictationFailed: "Diktieren fehlgeschlagen.",
      dictationFinalizing: "Diktieren wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Das Diktieren wurde beendet, bevor das letzte Teiltranskript abgeschlossen werden konnte.",
      dictationProviderUnavailable:
        "Für das Diktieren ist kein Transkriptionsanbieter konfiguriert.",
