...
export const es: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG o WebP. Las imágenes se recortan al centro y se redimensionan a 512 px.",
  ...
  configView: {
    ...
    syncedHint: "Sincronizado en tus dispositivos a través del gateway.",
    notifications: {
      title: "Notificaciones push",
      nativeTitle: "Notificaciones",
      hint: "Recibe notificaciones push del navegador desde tu gateway.",
      nativeHint: "Las notificaciones se muestran de forma nativa por la app OpenClaw en este Mac.",
  ...
  subtitles: {
    ...
    labs: "Capacidades experimentales de agente y herramientas.",
    ...
    advanced:
      "Todas las demás secciones de configuración, además del editor de archivos sin procesar.",
  ...
  custodian: {
    ...
    connectionChanged:
      "La conexión del Gateway cambió. Reintenta para continuar con esta configuración.",
    sessionRestarted:
    ...
    history: {
      ...
      description: "Qué cambió en este sistema, primero lo más reciente.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Permite que los agentes combinen herramientas en flujos de trabajo compactos y aislados de JavaScript.",
    },
    swarm: {
      title: "Swarm",
  ...
  board: {
    ...
    emptyHint: "Tu agente puede anclar widgets aquí; prueba a pedir una tarjeta de estado.",
    ...
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén Alt presionado y pulsa una tecla de flecha para moverlo.",
      ...
      appLoading: "Restaurando la app…",
      appStaleTitle: "Esta app anclada está desactualizada",
  ...
  chat: {
    ...
    board: {
      ...
      resizeDock: "Redimensionar anclaje del chat",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del editor, habla y luego suelta para insertar texto sin enviar.",
