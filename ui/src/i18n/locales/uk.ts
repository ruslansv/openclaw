...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Збережену сесію WhatsApp не очищено. Можливо, її вже немає, або каталог автентифікації потребує ручного очищення.",
    },
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображається під час виконання сесій.",
  ...
  subtitles: {
    ...
    security: "Автентифікація Gateway, політика виконання, профіль інструментів та схвалення.",
    advanced: "Усі інші розділи конфігурації, а також редактор сирого файлу.",
  ...
  custodian: {
    ...
    connectionChanged: "З'єднання з Gateway змінилося. Повторіть, щоб продовжити це налаштування.",
    sessionRestarted:
    ...
    history: {
      button: "Історія",
      title: "Нещодавні зміни",
      description: "Що змінилося в цій системі, найновіше зверху.",
      loading: "Завантаження нещодавніх змін…",
  ...
  mcpServers: {
    ...
    nameTaken: "Сервер MCP з назвою «{name}» уже існує.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Ваш телефон на Android як повноцінний вузол OpenClaw — чат, камера й Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
  ...
  board: {
    ...
    widget: {
      ...
      rejectedDetail: "Цей віджет залишається неактивним, доки його не видалять або замінять.",
      appLoading: "Відновлення застосунку…",
      appStaleTitle: "Цей закріплений застосунок застарів",
      appStaleDetail: "Його сервер, ресурс або початковий транскрипт більше недоступні.",
      retry: "Повторити",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Головна",
      mockPlaceholder: "Відображення дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
    ...
    messages: {
      activity: "Активність",
      forkFromHere: "Розгалужити звідси",
      hide: "Приховати",
    ...
    composer: {
      ...
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може переглядати камери.",
      ...
      dictationBrowserAudioUnsupported:
        "Цей браузер не може захоплювати аудіо для диктування з частотою 8 кГц.",
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено, перш ніж вдалося завершити останню часткову транскрипцію.",
