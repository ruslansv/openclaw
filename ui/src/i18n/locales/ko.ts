...
export const ko: TranslationMap = {
  ...
  configView: {
    ...
    syncedHint: "Gateway를 통해 모든 기기에서 동기화됩니다.",
    notifications: {
      title: "푸시 알림",
      nativeTitle: "알림",
      hint: "Gateway에서 브라우저 푸시 알림을 받습니다.",
      nativeHint: "이 Mac의 OpenClaw 앱에서 알림이 네이티브로 표시됩니다.",
  ...
  subtitles: {
    ...
    notifications: "게이트웨이에서 오는 브라우저 푸시 알림입니다.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} 상태가 저하됨 — 무슨 일이 있었는지 물어보세요",
      channelFallback: "채널",
      dismiss: "이 업데이트 무시",
    },
  },
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 간결한 샌드박스 JavaScript 워크플로에서 도구를 조합할 수 있게 합니다.",
    },
    swarm: {
      title: "Swarm",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "표시 이름",
      displayNameDescription: "이 게이트웨이를 사용하는 다른 사람들에게 표시됩니다.",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt를 누른 채 화살표 키를 눌러 옮기세요.",
      moveHandle: "{title} 이동",
  ...
  chat: {
    ...
    board: {
      ...
      reopenChat: "채팅 표시",
      defaultTab: "메인",
      mockPlaceholder: "보드 뷰 심 · {tabs}개 탭 · {widgets}개 위젯",
      mockOverview: "개요",
      mockResearch: "리서치",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "작성기 마이크 버튼을 누른 채 말한 다음 놓으면 전송하지 않고 텍스트가 삽입됩니다.",
      ...
      dictationProviderUnavailable: "받아쓰기에 대해 구성된 전사 공급자가 없습니다.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "이미지로 내보내려면 이 위젯을 다시 렌더링해야 합니다.",
