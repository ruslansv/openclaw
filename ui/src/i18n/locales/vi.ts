...
export const vi: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG, hoặc WebP. Ảnh được cắt ở giữa và đổi kích thước thành 512px.",
      ...
      avatarTooLarge: "Ảnh đại diện đã xử lý vẫn quá lớn.",
  ...
  configView: {
    ...
    syncedHint: "Được đồng bộ giữa các thiết bị của bạn thông qua gateway.",
    notifications: {
      title: "Thông báo đẩy",
  ...
  subtitles: {
    ...
    apps: "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính để bàn và trình duyệt.",
  ...
  mcpServers: {
    ...
    nameInvalid: "Tên máy chủ sử dụng chữ cái, số, dấu chấm, dấu gạch ngang hoặc dấu gạch dưới.",
    targetInvalid: "Nhập URL http(s) hoặc một dòng lệnh.",
    nameTaken: "Máy chủ MCP có tên “{name}” đã tồn tại.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong quy trình JavaScript nhỏ gọn, được cách ly an toàn.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt của bạn — cùng với các plugin để mở rộng khả năng của agent.",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Ảnh đại diện",
      avatarDescription:
        "PNG, JPEG hoặc WebP. Ảnh được thay đổi kích thước xuống 256 × 256 hoặc nhỏ hơn.",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Hãy chọn hình ảnh có kích thước từ 10 MB trở xuống.",
  ...
  chat: {
    ...
    board: {
      ...
      dockMenu: "Bố cục trò chuyện: {dock}",
      ...
      resizeDock: "Thay đổi kích thước bố cục trò chuyện",
      reopenChat: "Hiện trò chuyện",
      defaultTab: "Chính",
      mockPlaceholder: "Đường ghép chế độ bảng · {tabs} tab · {widgets} widget",
      mockOverview: "Tổng quan",
      mockResearch: "Nghiên cứu",
      mockSessionStatus: "Trạng thái chuỗi tin nhắn",
    ...
    messages: {
      ...
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Agent vẫn nhìn thấy nó.",
      ...
      rewindUnavailable: "Không thể tua lại khi agent đang làm việc",
      forkUnavailable: "Không thể rẽ nhánh khi agent đang làm việc",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Giữ nút micro của trình soạn thảo, nói, rồi thả ra để chèn văn bản mà không gửi.",
      ...
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi bản ghi một phần cuối cùng có thể được hoàn tất.",
      dictationProviderUnavailable:
        "Chưa có nhà cung cấp phiên âm nào được cấu hình cho đọc chính tả.",
